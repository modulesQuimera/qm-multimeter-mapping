...
module.exports = function(RED) {
    function multimeter_mappingNode(config) {
        ...
        var map_multimeter = [
            ...
            { feat: "A1", pin: "PIN 29", board: `TP ${config.labelPort1}` },
            { feat: "A2", pin: "PIN 27", board: `TP ${config.labelPort2}` },
            { feat: "A3", pin: "PIN 25", board: `TP ${config.labelPort3}` },
            { feat: "A4", pin: "PIN 23", board: `TP ${config.labelPort4}` },
            { feat: "A5", pin: "PIN 21", board: `TP ${config.labelPort5}` },
            { feat: "A6", pin: "PIN 19", board: `TP ${config.labelPort6}` },
            { feat: "A7", pin: "PIN 17", board: `TP ${config.labelPort7}` },
            { feat: "A8", pin: "PIN 15", board: `TP ${config.labelPort8}` },
            { feat: "A9", pin: "PIN 13", board: `TP ${config.labelPort9}` },
            { feat: "A10", pin: "PIN 11", board: `TP ${config.labelPort10}` },
            { feat: "A11", pin: "PIN 9", board: `TP ${config.labelPort11}` },
            { feat: "AGND", pin: "PIN 7", board: `TP ${config.labelPort12}` },
            { feat: "APW", pin: "PIN 5", board: `TP ${config.labelPort13}` },
            { feat: "BPW", pin: "PIN 3", board: `TP ${config.labelPort14}` },
            { feat: "CPW", pin: "PIN 1", board: `TP ${config.labelPort15}` },
            { feat: "B1", pin: "PIN 30", board: `TP ${config.labelPort16}` },
            { feat: "B2", pin: "PIN 28", board: `TP ${config.labelPort17}` },
            { feat: "B3", pin: "PIN 26", board: `TP ${config.labelPort18}` },
            { feat: "B4", pin: "PIN 24", board: `TP ${config.labelPort19}` },
            { feat: "B5", pin: "PIN 22", board: `TP ${config.labelPort20}` },
            { feat: "B6", pin: "PIN 20", board: `TP ${config.labelPort21}` },
            { feat: "B7", pin: "PIN 18", board: `TP ${config.labelPort22}` },
            { feat: "B8", pin: "PIN 16", board: `TP ${config.labelPort23}` },
            { feat: "B9", pin: "PIN 14", board: `TP ${config.labelPort24}` },
            { feat: "B10", pin: "PIN 12", board: `TP ${config.labelPort25}` },
            { feat: "B11", pin: "PIN 10", board: `TP ${config.labelPort26}` },
            { feat: "INPW", pin: "PIN 8", board: `TP ${config.labelPort27}` },
            { feat: "IAPW", pin: "PIN 6", board: `TP ${config.labelPort28}` },
            { feat: "IBPW", pin: "PIN 4", board: `TP ${config.labelPort29}` },
            { feat: "ICPW", pin: "PIN 2", board: `TP ${config.labelPort30}` },
